            ...
            while true do
                if DoesEntityExist(obj) and not targetPlaced then
                    exports.qtarget:AddBoxZone("boomboxzone", coords, 1, 1, {
                        ...
                        options = {
                            {
                                event = 'boombox:interact',
                                icon = 'fas fa-hand-paper',
                                label = 'Interact',
                            },
                            {
                                event = 'boombox:pickup',
...
if Framework == "ESX" then
    savedSongsMenu = function(radio)
        ESX.TriggerServerCallback('boombox:getSavedSongs', function(cb)
